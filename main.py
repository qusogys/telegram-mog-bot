...
1. Юзернейм: длина (чем короче — тем выше балл),смысл слова - если юзернейм не простая наьор цифр и букв, а слова со смыслом это +балл, осмысленность, отсутствие случайных цифр.
2. Аватарка: визуал, вайб, стиль, качество, актуальность.
